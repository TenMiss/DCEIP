function [kernel, interim_latent] = blind_deconv(y, lambda, Blambda,lambda_grad, opts, patch_r)
...
for s = num_scales:-1:1
  ...
  [ks, lambda,Blambda, lambda_grad, interim_latent] = blind_deconv_main(ys, ks, lambda, Blambda,...
...
%   imwrite(interim_latent,['results_specific\',int2str(s), '_interim_result2.png']);
